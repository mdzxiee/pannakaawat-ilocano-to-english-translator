...
# Verb-initial constructions (common in Ilocano)
...
# Adjective-initial constructions (common in Ilocano)
...
# Noun phrases
NP -> NN | NNS | NNP | DT NN | DT NNS | DT NNP 
...
# Terminal nodes for all parts of speech
DT -> 'DT'
NN -> 'NN'
JJ -> 'JJ'
VB -> 'VB'
